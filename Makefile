...
quality-gates:
	...
	ruff check . --fix
	ruff format .
	basedpyright unified_domain_services/
	pytest --cov=unified_domain_services --cov-report=term-missing
...
coverage:
	pytest --cov=unified_domain_services --cov-report=term-missing --cov-report=html
