...
def create_backtesting_cloud_service(
    ...
    resolved_bucket = bucket or gcs_bucket or "backtest-store"
...
def create_features_cloud_service(
    ...
    resolved_bucket = bucket or gcs_bucket or "features-store"
...
def create_instruments_cloud_service(
    ...
    resolved_bucket = bucket or gcs_bucket or "instruments-store"
...
def create_market_data_cloud_service(
    ...
    resolved_bucket = bucket or gcs_bucket or "market-data-tick"
...
def create_strategy_cloud_service(
    ...
    resolved_bucket = bucket or gcs_bucket or "strategy-store"
